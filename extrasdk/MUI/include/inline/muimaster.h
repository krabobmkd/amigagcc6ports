...
#define MUI_NewObject(___class, ___tags, ...) \
    ({_sfdc_vararg _tags[] = { ___tags, __VA_ARGS__ }; MUI_NewObjectA((___class), (struct TagItem *) _tags); })
...
#define MUI_RequestA(___app, ___win, ___flags, ___title, ___gadgets, ___format, ___params) \
      LP7(0x2a, LONG, MUI_RequestA , APTR, ___app, d0, APTR, ___win, d1, LONGBITS, ___flags, d2, char *, ___title, a0, char *, ___gadgets, a1, char *, ___format, a2, APTR, ___params, a3,\
      , MUIMASTER_BASE_NAME)
...
#define MUI_CreateCustomClass(___base, ___supername, ___supermcc, ___datasize, ___dispatcher) \
      LP5(0x6c, struct MUI_CustomClass *, MUI_CreateCustomClass , struct Library *, ___base, a0, char *, ___supername, a1, struct MUI_CustomClass *, ___supermcc, a2, int, ___datasize, d0, APTR, ___dispatcher, a3,\
      , MUIMASTER_BASE_NAME)
...
#define MUI_ObtainPen(___mri, ___spec, ___flags) \
      LP3(0x9c, LONG, MUI_ObtainPen , struct MUI_RenderInfo *, ___mri, a0, struct MUI_PenSpec *, ___spec, a1, ULONG, ___flags, d0,\
      , MUIMASTER_BASE_NAME)
