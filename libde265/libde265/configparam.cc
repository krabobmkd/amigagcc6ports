...
//VF-Amiga
#if AMIGA
    printf("VF: config_parameters::get_parameter_type type is:%s\n",param);
    if(strcmp(param,"(boolean)")==0) return en265_parameter_bool;
    if(strcmp(param,"(string)")==0) return en265_parameter_string;
    if(strcmp(param,"(int)")==0) return en265_parameter_int;
    //TODO VF for  en265_parameter_choice
...
//VF-Amiga
  ...
  assert(o);
#else
    choice_option_base* o = (choice_option_base*)(option);
#endif
...
//VF-Amiga
#if AMIGA
    option_bool* o = (option_bool*)(option);
#else
...
bool config_parameters::set_int(const char* param, int value)
{
  ...
  //VF-Amiga
#if AMIGA
  option_int* o = (option_int*)(option);
#else
...
//VF-Amiga
#if AMIGA
  option_string* o = (option_string*)(option);
#else
