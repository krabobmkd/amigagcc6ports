...
//Vf-Amiga: amiga system include at some level does a macro with #define read ...
// Amiga system include macros may interfere at any moment. a simple way to correct is this:
#ifdef read
#undef read
#endif
