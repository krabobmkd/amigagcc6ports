                                         ...
                                         const heif_color_conversion_options& options) const
{
  ...
  #else
    int r_cr = static_cast<int>(256.0f * coeffs.r_cr);
    int g_cr = static_cast<int>(256.0f  * coeffs.g_cr);
    int g_cb = static_cast<int>(256.0f  * coeffs.g_cb);
    int b_cb = static_cast<int>(256.0f * coeffs.b_cb);
  #endif
