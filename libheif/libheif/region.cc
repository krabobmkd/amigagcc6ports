...
Error RegionItem::parse(const std::vector<uint8_t>& data)
{
  ...
  for (int i = 0; i < region_count; i++) {
    ...
    if (geometry_type == heif_region_type_point) {
        cout <<"parse: RegionGeometry_Point" << endl;
